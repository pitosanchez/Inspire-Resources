      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-12">
        ...
        >
          ...
          <div className="relative z-10 p-8 md:p-12">
            ...
            <div className="max-w-4xl mx-auto text-center mb-16">
              ...
              <div className="mb-6 md:mb-8">
                <a
                  href={`${
                    import.meta.env.BASE_URL
                  }AKF-Transplant-Toolkit-Digital- English.pdf`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-blue-100 hover:bg-sky-100 text-blue-800 hover:text-blue-900 font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105 border-2 border-blue-300 hover:border-sky-300"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
                  ...
                  <span>Open The Transplant Toolkit Guide</span>
                  <svg
                    className="w-4 h-4"
                    fill="none"
                    stroke="currentColor"
            ...
            <div id="overview" ref={overviewRef} className="max-w-4xl mx-auto">
              ...
              <Card
                variant="elevated"
                className="p-8 mb-8 bg-white/98 backdrop-blur-sm shadow-xl"
              >
                <h3 className="text-2xl font-serif text-neutral-900 mb-4">
                  {t("guide.overview.what.title") ||
                    "What is a kidney transplant?"}
                </h3>
                <p className="text-lg text-neutral-700 leading-relaxed mb-6">
                  {t("guide.overview.what.text") ||
                    "A kidney transplant is a treatment option for you if your kidneys are not working well enough on their own. This is called kidney failure, also called end stage kidney disease or end stage renal disease. It is a surgery to give a person with kidney failure (the recipient) a healthy kidney from someone else (the donor)."}
                </p>

                <h3 className="text-2xl font-serif text-neutral-900 mb-4">
                  {t("guide.overview.why.title") ||
                    "Why should I consider getting a transplant?"}
                </h3>
                <div className="space-y-4">
                  <div>
                    <h4 className="text-xl font-semibold text-neutral-900 mb-2">
                      {t("guide.overview.why.quality.title") ||
                        "Improve your quality of life"}
                    </h4>
                    <p className="text-neutral-700 leading-relaxed">
                      {t("guide.overview.why.quality.text") ||
                        "While a kidney transplant is a major surgery and can seem scary, there can be many positive lifestyle changes. You may be able to return to the life you lived before kidney failure. You will no longer need dialysis and have fewer food and drink limits (restrictions), but it will still be important to keep a healthy weight and eat healthy foods."}
                    </p>
                  </div>
                </div>
              </Card>
        ...
        <div className="max-w-4xl mx-auto mb-20">
          <Card variant="elevated" className="p-8 mb-8">
            <div className="space-y-4 mb-6">
              <div>
                <h4 className="text-xl font-semibold text-neutral-900 mb-2">
                  {t("guide.overview.why.longer.title") ||
                    "Increase your chance of living longer"}
                </h4>
                <p className="text-neutral-700 leading-relaxed">
                  {t("guide.overview.why.longer.text") ||
                    "Studies show that people who get a kidney transplant have a higher chance of living longer than people who stay on dialysis. On average:"}
                </p>
                <ul className="list-disc list-inside mt-2 space-y-2 text-neutral-700">
                  <li>
                    {t("guide.overview.why.longer.stat1") ||
                      "People who are on dialysis have a 40% chance of living after 5 years with kidney failure."}
                  </li>
                  <li>
                    {t("guide.overview.why.longer.stat2") ||
                      "People who get a kidney transplant have a 80% chance of living after 5 years with kidney failure."}
                  </li>
                </ul>
              </div>
            </div>
            ...
            <h3 className="text-2xl font-serif text-neutral-900 mb-4">
              {t("guide.overview.when.title") ||
                "When is the right time to get a kidney transplant?"}
            </h3>
            <p className="text-lg text-neutral-700 leading-relaxed mb-4">
              {t("guide.overview.when.text") ||
                "The right time for you to get a kidney transplant may be different from others. Your doctor will work with you to decide the right time for you to get a transplant. If possible, the best time to get a transplant is before you need dialysis, which is called a preemptive transplant."}
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="p-6 bg-gradient-to-br from-accent-50 to-white">
                <h4 className="text-xl font-semibold text-neutral-900 mb-3">
                  {t("guide.overview.living.title") ||
                    "Living Donor Transplant"}
                </h4>
                <p className="text-neutral-700 mb-4">
                  {t("guide.overview.living.desc") ||
                    "A living donor kidney transplant is surgery where doctors give you a kidney from a person who is alive and chooses to donate one of their two healthy kidneys."}
                </p>
                <ul className="space-y-2 text-sm text-neutral-700">
                  <li>
                    •{" "}
                    {t("guide.overview.living.directed") ||
                      "Directed donation - from someone you know"}
                  </li>
                  <li>
                    •{" "}
                    {t("guide.overview.living.paired") ||
                      "Paired exchange (kidney swap)"}
                  </li>
                  <li>
                    •{" "}
                    {t("guide.overview.living.altruistic") ||
                      "Altruistic donation - from a stranger"}
                  </li>
                  <li>
                    •{" "}
                    {t("guide.overview.living.voucher") ||
                      "Transplant voucher program"}
                  </li>
                </ul>
              </Card>
              <Card className="p-6 bg-gradient-to-br from-brand-50 to-white">
                <h4 className="text-xl font-semibold text-neutral-900 mb-3">
                  {t("guide.overview.deceased.title") ||
                    "Deceased Donor Transplant"}
                </h4>
                <p className="text-neutral-700">
                  {t("guide.overview.deceased.desc") ||
                    "A deceased donor kidney transplant is a surgery where doctors give you a kidney from an organ donor who has died. The average wait time is 3-5 years for a deceased donor's kidney and may be longer or shorter in some parts of the country."}
                </p>
              </Card>
            </div>
          </Card>
        ...
        <div id="roadmap" className="max-w-6xl mx-auto mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-600">{t("roadmap.subtitle")}</p>
          </div>
        ...
        <div id="transplant-center" className="max-w-4xl mx-auto mb-20">
          ...
          <Card variant="elevated" className="p-8">
            ...
            <p className="text-lg text-neutral-700 leading-relaxed mb-6">
              {t("guide.center.what.text") ||
                "A transplant center is a hospital with a special team of doctors, nurses, and other healthcare workers who help people get organ transplants. These centers have the experience and resources needed for transplant surgery and care."}
            </p>

            <h3 className="text-2xl font-serif text-neutral-900 mb-4">
              {t("guide.center.why.title") ||
                "Why the Transplant Center Matters"}
            </h3>
            <p className="text-lg text-neutral-700 leading-relaxed mb-4">
              {t("guide.center.why.text") ||
                "Choosing the right transplant center is important because different centers have different rules and requirements, wait times vary, and you want a team you trust and feel comfortable with."}
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                t("guide.center.team.coordinator") ||
                  "Transplant Coordinator - Your main contact person",
                t("guide.center.team.surgeons") ||
                  "Transplant Surgeons - Perform the surgery",
                t("guide.center.team.nephrologists") ||
                  "Nephrologists - Manage your kidney health",
                t("guide.center.team.nurses") ||
                  "Nurses - Provide day-to-day care",
                t("guide.center.team.social") ||
                  "Social Workers - Help with support and resources",
                t("guide.center.team.financial") ||
                  "Financial Coordinators - Help with insurance and costs",
              ].map((item, index) => (
        ...
        <div id="eligibility" className="max-w-6xl mx-auto mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-600">{t("eligibility.intro")}</p>
          </div>
          ...
          <Card variant="brand" className="mt-8 p-6 text-center">
            ...
            <p className="text-brand-800">{t("eligibility.note.desc")}</p>
          </Card>
        </div>
        ...
        <div id="caregiver" className="max-w-4xl mx-auto mb-20">
          ...
          <Card variant="elevated" className="p-8">
            ...
            <p className="text-lg text-neutral-700 leading-relaxed mb-6">
              {t("guide.caregiver.what.text") ||
                "A caregiver is someone who helps you during your transplant journey. This person supports you before, during, and after your transplant surgery. Having a good caregiver is very important for your recovery and success."}
            </p>
            ...
            <p className="text-lg text-neutral-700 leading-relaxed mb-4">
              {t("guide.caregiver.why.text") ||
                "After your transplant, you'll need help with many things: getting to appointments, taking medications, daily tasks, emotional support, and watching for problems. Transplant centers require that you have a reliable caregiver."}
            </p>
          ...
          <Card variant="elevated" className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              {[
                ...
                {
                  title: t("donor.scheduled"),
                  desc: t("donor.scheduled.desc"),
                },
              ].map((benefit, index) => (
            ...
            <p className="text-lg text-neutral-700 leading-relaxed mb-4">
              {t("guide.finding.who.text") ||
                "Many people can be living donors. Don't assume someone can't donate - let the transplant center evaluate them. Family members, friends, coworkers, and sometimes even strangers (altruistic donors) can donate."}
            </p>

            <div className="bg-brand-50 p-6 rounded-lg">
              <p className="font-semibold text-neutral-900 mb-2">
                {t("guide.finding.matching.title") ||
                  "Important Facts About Matching"}
              </p>
              <p className="text-neutral-700">
                {t("guide.finding.matching.text") ||
                  "Race and ethnicity don't matter for matching! This is a common myth. Your donor doesn't need to be the same race or ethnicity as you."}
              </p>
            </div>
          </Card>
        </div>
        ...
        <div id="becoming-donor" className="max-w-4xl mx-auto mb-20">
          ...
          <Card variant="elevated" className="p-8">
            ...
            <p className="text-lg text-neutral-700 leading-relaxed mb-6">
              {t("guide.becoming.what.text") ||
                "Living donation is when a healthy person gives one of their kidneys to someone who needs a transplant. This is a generous and life-saving gift that helps someone in need."}
            </p>
            ...
            <div className="bg-accent-50 p-6 rounded-lg mb-6">
              <p className="text-lg font-semibold text-neutral-900 mb-2">
                {t("guide.becoming.safe.answer") ||
                  "Yes, living donation is very safe for healthy donors."}
              </p>
              <ul className="list-disc list-inside space-y-2 text-neutral-700 mt-4">
                <li>
                  {t("guide.becoming.safe.fact1") ||
                    "You can live a completely normal life with one kidney"}
                </li>
                <li>
                  {t("guide.becoming.safe.fact2") ||
                    "Your remaining kidney will do the work of two"}
                </li>
                <li>
                  {t("guide.becoming.safe.fact3") ||
                    "Most donors recover quickly and have no long-term problems"}
                </li>
                <li>
                  {t("guide.becoming.safe.fact4") ||
                    "Donors live just as long as people who don't donate"}
                </li>
              </ul>
            </div>
            ...
            <p className="text-lg text-neutral-700 leading-relaxed">
              {t("guide.becoming.who.text") ||
                "Usually age 18 to 65, in good overall health, have two healthy kidneys, no serious health problems, normal blood pressure and kidney function, and willing and able to donate voluntarily."}
            </p>
          </Card>
        </div>
        ...
        <div id="questions" className="max-w-4xl mx-auto mb-20">
          ...
          <Card variant="elevated" className="p-8">
            ...
            <p className="text-lg text-neutral-700 leading-relaxed mb-6">
              {t("guide.questions.why.text") ||
                "Asking questions helps you understand your transplant journey better, feel more confident and prepared, make informed decisions about your care, and build trust with your care team."}
            </p>
            ...
            <div className="space-y-6">
              {[
                {
                  title:
                    t("guide.questions.starting.title") ||
                    "Questions About Getting Started",
                  items: [
                    t("guide.questions.starting.1") ||
                      "When should I start thinking about a transplant?",
                    t("guide.questions.starting.2") ||
                      "How do I get started with the evaluation?",
                    t("guide.questions.starting.3") ||
                      "How long does the whole process take?",
                  ],
                },
                {
                  title:
                    t("guide.questions.evaluation.title") ||
                    "Questions About Evaluation",
                  items: [
                    t("guide.questions.evaluation.1") ||
                      "How long will my evaluation take?",
                    t("guide.questions.evaluation.2") ||
                      "What tests will I need?",
                    t("guide.questions.evaluation.3") ||
                      "What are your requirements for transplant?",
                  ],
                },
                {
                  title:
                    t("guide.questions.waitlist.title") ||
                    "Questions About Being on the Waitlist",
                  items: [
                    t("guide.questions.waitlist.1") ||
                      "How long will I wait for a kidney?",
                    t("guide.questions.waitlist.2") ||
                      "What should I do while I wait?",
                    t("guide.questions.waitlist.3") ||
                      "How will you contact me when a kidney is available?",
                  ],
                },
                {
                  title:
                    t("guide.questions.surgery.title") ||
                    "Questions About Surgery",
                  items: [
                    t("guide.questions.surgery.1") ||
                      "How long will the surgery take?",
                    t("guide.questions.surgery.2") ||
                      "How long will I stay in the hospital?",
                    t("guide.questions.surgery.3") ||
                      "What will recovery be like?",
                  ],
                },
                {
                  title:
                    t("guide.questions.medications.title") ||
                    "Questions About Medications",
                  items: [
                    t("guide.questions.medications.1") ||
                      "What medications will I need to take?",
                    t("guide.questions.medications.2") ||
                      "How long will I need to take them?",
                    t("guide.questions.medications.3") ||
            ...
            <div className="mt-8 p-6 bg-brand-50 rounded-lg">
              <p className="text-lg font-semibold text-neutral-900 mb-2">
                {t("guide.questions.remember") ||
                  "Remember: There are no silly questions. Your transplant team wants you to understand everything. Don't be afraid to ask anything you're wondering about."}
              </p>
            </div>
          </Card>
        </div>
