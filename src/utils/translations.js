...
export const translations = {
  en: {
    ...
    'about.combined.text': 'We\'re dedicated to ensuring everyone has fair access to life-saving kidney transplants, regardless of background, income, or circumstances. Every person deserves equal access to life-saving care. We\'re here to make that vision a reality. At INSPIRE, we believe that access to life-saving kidney transplants should never depend on where you live, how much you earn, or the color of your skin. We are dedicated to breaking down systemic barriers that prevent underserved communities from receiving the care they deserve. The path to a kidney transplant is complex and challenging for everyone, but for underserved communities, the journey is often marked by additional obstacles that can seem insurmountable. These barriers don\'t just delay care—they can prevent life-saving treatment entirely. We don\'t just identify problems—we create solutions. INSPIRE works hand-in-hand with trusted transplant centers, healthcare providers, and community organizations to design programs that make kidney transplant access more fair and equal for everyone. Our comprehensive approach addresses barriers at every stage of the transplant journey. Through comprehensive education, personalized support, and strong community partnerships, we empower individuals and families with the knowledge, resources, and advocacy they need to navigate the transplant journey with confidence and dignity. We envision a future where every person facing kidney disease has equal access to transplant care, regardless of their background or circumstances. A future where communities are empowered with knowledge, healthcare systems are equitable, and no one faces this journey alone. Numbers tell a story, but behind every statistic is a person—a patient, a family, a community. INSPIRE helps individuals navigate the transplant journey with dignity, support, and hope.',
  ...
  es: {
    ...
    'about.combined.text': 'Estamos dedicados a asegurar que todos tengan acceso justo a trasplantes de riñón que salvan vidas, independientemente de su origen, ingresos o circunstancias. Cada persona merece igual acceso a atención que salva vidas. Estamos aquí para hacer esa visión una realidad. En INSPIRE, creemos que el acceso a trasplantes de riñón que salvan vidas nunca debe depender de dónde vives, cuánto ganas o el color de tu piel. Estamos dedicados a derribar barreras sistémicas que impiden que las comunidades desatendidas reciban la atención que merecen. El camino hacia un trasplante de riñón es complejo y desafiante para todos, pero para las comunidades desatendidas, el viaje a menudo está marcado por obstáculos adicionales que pueden parecer insuperables. Estas barreras no solo retrasan la atención—pueden prevenir el tratamiento que salva vidas por completo. No solo identificamos problemas—creamos soluciones. INSPIRE trabaja mano a mano con centros de trasplante de confianza, proveedores de atención médica y organizaciones comunitarias para diseñar programas que hagan el acceso al trasplante de riñón más justo e igualitario para todos. Nuestro enfoque integral aborda barreras en cada etapa del viaje de trasplante. A través de educación integral, apoyo personalizado y sólidas asociaciones comunitarias, empoderamos a individuos y familias con el conocimiento, recursos y defensa que necesitan para navegar el viaje de trasplante con confianza y dignidad. Imaginamos un futuro donde cada persona que enfrenta enfermedad renal tenga igual acceso a atención de trasplante, independientemente de su origen o circunstancias. Un futuro donde las comunidades estén empoderadas con conocimiento, los sistemas de salud sean equitativos, y nadie enfrente este viaje solo. Los números cuentan una historia, pero detrás de cada estadística hay una persona—un paciente, una familia, una comunidad. INSPIRE ayuda a los individuos a navegar el viaje de trasplante con dignidad, apoyo y esperanza.',
